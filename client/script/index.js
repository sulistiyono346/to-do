...
function register() {
    $("#error_login").html("")
    $("#error_register").html("")
    console.log($("#password_register").val());
    if ($("#password_register").val() === undefined) {
     ...
     `
        ...
        $.ajax({
            ...
            .fail((err) => {
                ...
                $("#error_register").html("")
                let data = Object.keys(err.responseJSON.err.errors)
                data.forEach(key => {
                    if (key === "name") {
                        $("#error_register").append(`
...
function login() {
    ...
    $.ajax({
        ...
        .done((data) => {
            ...
            console.log(err);
            $("#error_login").html("")
            if (Object.keys(err.responseJSON.err === null)) {
                $("#error_register").append(`
                <div class="ui error message mini">
                    ...
                    <div class="ui bottom attached tab segment" data-tab="second">
                        ...
                        <div class="ui container">
                            <div class="ui form" id="register">
                                ...
                                <div class="field">
                                    <label>password</label>
                                    <input type="password" name="password" placeholder="password" id="password_register">
                                </div>
        ...
        .done((data) => {
            $.each(data.tasks, function (index, value) {
                if (value.dueDate === null) {
                    ...
                    value.dueDate = value.dueDate.slice(0, 10)
                }
                $("#task").append(`
                <!-- uicard -->
                <div class="card">
